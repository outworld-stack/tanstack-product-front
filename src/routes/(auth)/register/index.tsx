...
function RegisterPage() {
  ...
  return (
    <div className='max-w-md mx-auto'>
      <h1 className='text-3xl text-center md:text-right font-VazirBold mb-10 backdrop-blur backdrop-opacity-50'>ثبت‌نام</h1>

      <section  className='space-y-4 backdrop-blur backdrop-opacity-50'>

        <input type="text" className="w-full bg-stone-900 text-white border border-gray rounded-md p-2" placeholder='نام' value={name} onChange={(e) => setName(e.target.value)} autoComplete='off' />
        ...
        <p className='text-center mt-4 select-none font-LalezarRegular backdrop-blur backdrop-opacity-50'>
          اکانت دارید؟
          <Link to='/login' className='text-amber-400 hover:underline mr-3'>
            ورود
          </Link>
        </p>
        {
